...
export default function Perfil() {
  ...
  const styles = {
    ...
    ButtonComents: {
      ...
      outline: 'none',
      margin: '0 0 0 35px',
      backgroundColor: perfilDisplay ? '#878787':'#a9a9a9'
    ...
    ButtonSettings: {
      ...
      outline: 'none',
      margin: '0 0 0 35px',
      backgroundColor: settingsDisplay ? '#878787':'#a9a9a9'
    },
    Button: {
      display: 'flex',
      cursor: 'pointer',
    ...
    return (
      <div style={styles.screen} className="flex h-screen w-screen bg-white">
        ...
        <div style={styles.opicoes}>
            ...
            <a style={styles.ButtonComents}  onClick={handleClickComentarios}><IconPerson/> Comentários</a>
            <a style={styles.ButtonSettings} onClick={handleClickConfiguracao}><IconSettings/> Configurações</a>
